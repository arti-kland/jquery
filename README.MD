...
-> On place la balise script en bas de body pour optimiser l'affichage de la page, permettant de traiter d'abord les elements important de la page le contenu et la presentation avnt de s'occuper des paillette !
...
-> cette fonction est indispenssable car elle assure que le document soit ready avant de lancer le script ce qui assure le bon fonctionement et l'optimisation d'affichage.  
...
-> le symbole $ est un raccourci qui signifie que jquery est utilisé si j'ecrit $("#id) ou jquery("#id") cela reviens au même !
...
-> le tag : $("blabla") pour tout selectionner,l'id : $("#toto") pour selectionner par id,la class : $(".toto"),pour selectionner la class toto.
